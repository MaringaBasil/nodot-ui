    ...
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      >
        {visible.map((item) => (
          <Pressable
            key={item.id}
            style={({ pressed }) => [styles.scanItem, pressed && { opacity: 0.75 }]}
          >
